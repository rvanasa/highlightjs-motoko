...
$pattern:"[a-zA-Z_]\\w*",
keyword:["actor","and","async","assert","await","break","case","catch","class","composite","continue","debug","debug_show","do","else","false","finally","flexible","for","from_candid","func","if","ignore","implicit","in","include","import","label","let","loop","mixin","module","not","null","object","or","persistent","private","public","query","return","shared","stable","switch","system","throw","to_candid","transient","true","try","type","var","weak","while","with"].filter((e=>!n.includes(e)&&"async"!==e)).join(" "),
literal:n.join(" "),
built_in:"async Any None Null Bool Int Int8 Int16 Int32 Int64 Nat Nat8 Nat16 Nat32 Nat64 Float Float32 Char Text Blob Error Principal"
